	...
	$MJO->NOTB('width="753" cellpadding="2" cellspacing="0"');
		...
		$MJO->NTR('align="center" class="c1"');
			...
			$MJO->NOTB('width="753" cellpadding="4" border="0" cellspacing="0"');
				...
				$F->input('class="c7"','<b id="destaque5">'.$_TITULO_SITE.'</b>','class="c7"','TYPE="TEXT" name="tituloSelecionado" value="LECTORIBUS V.0.1" size="60" onfocus=this.value=""');
				...
				$F->input('class="c1"','<b id="destaque5">'.$_NOME_EVENTO.'</b>','class="c1"','TYPE="TEXT" name="nomeEventoSelecionado" value="Leio e compreendo" size="60" onfocus=this.value=""');
				
				$MJO->NTR('align="left" colspan="2" class="c6"');
				$o = new printConteudo($_DICA_NOME_EVENTO_INSTALA);				
				$MJO->NCTR();

				$F->input('class="c1"','<b id="destaque5">'.$_PRE_REQUISITOS.'</b>','class="c1"','TYPE="TEXT" name="preRequisitosSelecionado" value="ex:Alunos de 7• série" size="60" onfocus=this.value=""');
				...
				$F->input('class="c1"','<b id="destaque5">'.$_LINK_RETORNO.'</b>','class="c1"','TYPE="TEXT" name="linkRedirecionaRetornoSelecionado" value="http://www.soordle.org" size="60" onfocus=this.value=""');
...
$FORM->fecha_form();
	...
	$MJO->NCTB();
	print "<center><br/><br/>";	
	$MJO->NOTB('width="753" class="c1" cellpadding="8" cellpadding="0" border="0"');
				$MJO->NTR('colspan="0" align="left" vAlign="top" class="c1" width="50%"');
				print mLink("1g","pt_br","0").mImg("1g","Português Brasil - Brazilian Portuguese");
		$MJO->NOTB('width="100%" class="c1" cellpadding="8" cellpadding="0"');
				$MJO->NTR('colspan="0" align="left" vAlign="top" class="c1"');
				$o = new printConteudo("<b id='destaque3'><ul><li>Sistema de ensino digital (a distância ou presencial) para trabalhos escolares baseados no Idioma natal.</li><li>(Cadastro e Gerenciamento) em base de dados XML</li><li>Consiste basicamente na leitura e interpretação de textos, podendo ser ampliado através de ciração de módulos específicos.</li></ul></b>");
				$o = new printConteudo('<b id="destaque10"><ul><li>As traduções utilizadas neste sistema foram realizadas usando a ferramenta de tradução do Google.Isto é, podem existir muitos erros nas mesmas!</b></li></ul></b>');
				$MJO->NCTR();	
				$MJO->NTR('align="left" class="c1" vAlign="top"');				
				$o = new printConteudo("<b>Por favor selecione um idioma para a instalação.</b>");	
				$MJO->NCTR();
		$MJO->NCTB();	
	$MJO->NTD('vAlign="top" class="c1"');
	print mLink("3g","en_us","3").mImg("3g","English -  USA");					
			$MJO->NOTB('width="100%" class="c1" cellpadding="8" cellpadding="0"');
				$MJO->NTR('align="left" class="c1" vAlign="top"');
				$o = new printConteudo("<b id='destaque3'><ul><li>System digital teaching (classroom or distance) for school-based native language.</li><li> (Registration and Management) based on XML data </li> <li> basically consists in reading and interpreting texts and may be extended through ciração specific modules. </li></ul></b>");
				$o = new printConteudo("<b id='destaque10'><ul><li>The translations used in this system were conducted using the translation tool Google.Isto is, there may be many errors in the same!</li></ul></b><br/><br/><br/>");
				$MJO->NCTR();	
				$MJO->NTR('align="left" class="c1" vAlign="top"');
				$o = new printConteudo("<b>Please select a language to install.</b>");
			$MJO->NCTB();

	$MJO->NTR('colspan="2" align="left" vAlign="top" class="c1"');
			$MJO->NOTB('width="100%" class="c1" cellpadding="8" cellpadding="0"');					
