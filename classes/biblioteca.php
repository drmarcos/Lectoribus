...
class printConteudo extends montaHtml
{
   public function __construct()
    ...
    {
			global $COR7;
			$this->NTR('class="'.$COR7.'" vAlign="top" width="70%"');
				print($a1.PHP_EOL);
			$this->NTD('class="'.$COR7.'" vAlign="top"');
				print($a2.PHP_EOL);
			$this->NCTR();		
    }
    ...
    {
			global $COR11,$COR7;
			$this->NTR('class="'.$COR11.'" vAlign="top" width="100%" colspan="2"');
				print($a1.PHP_EOL).'<br/><br/>';
				print($a2.PHP_EOL).'<br/><br/>';
				print($a3.PHP_EOL).'<br/><br/>';
			$this->NCTR();	      
			$this->NTR('class="'.$COR7.'" vAlign="top" width="100%" colspan="2"');
				print($a4.PHP_EOL);
			$this->NCTR();	      
    }
