...
print "<center>";
			...
			$MJO->NOTB('class='.$COR1.' cellpadding="4" cellspacing="0" width="753"');
				$MJO->NTR('colspan="1" align="RIGHT" vAlign="top" class='.$COR4.'');
					$o = new printConteudo(''.$MJO->imagensTag("$CFG->iconeExcel","","48","48").'');
				$MJO->NCTB();	
			$MJO->NOTB('class='.$COR1.' cellpadding="4" cellspacing="0" width="753"');
				$MJO->NTR('colspan="1" align="left" vAlign="top" class='.$COR1.'');
					$o = new printConteudo('<b id="destaque5">'.$_BREVE.'!</b><br/><b id="destaque10">'.$_EXPORTAR." ".$_PARA_FORMATO.'[ .XLS - EXCEL ]</b>');
				$MJO->NCTR();	
