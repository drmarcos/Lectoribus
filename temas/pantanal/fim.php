...
$MJO->NOTB('border="0" cellspacing="0" cellpadding="8" width="100%"');
	$MJO->NTR('class='.$COR1.' WIDTH="60%" align="CENTER"');
			?>																									
			<a href="https://pagseguro.uol.com.br/checkout/v2/donation.html?receiverEmail=suporte.eadgames@gmail.com&currency=BRL" target="_blank"><img src="https://p.simg.uol.com.br/out/pagseguro/i/botoes/doacoes/209x48-doar-cinza-assina.gif"  alt="Pague com PagSeguro - é rápido, grátis e seguro!" /></a>
...
$MJO->NCTB();
$MJO->NOTB('class="topo"');
	$MJO->NTR('class='.$COR3.' align="right"');	
